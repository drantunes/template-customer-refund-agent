...
export type VerifiedIntercomConversationWebhook =
  AuthenticatedIntercomNotification & {
    kind: "conversation";
...
export type VerifiedIntercomWebhook =
  VerifiedIntercomPing | VerifiedIntercomConversationWebhook;
